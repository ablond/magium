# The clone ambush begins - Book 1 Moment Illustration
...
- Chapter: `ch11b`
- Trigger scene: `Ch11b-Clones`
- Moment id: `ch11b-clone-ambush`
...
- Zack: `public/visuals/book1/characters/zack/portrait.webp` as `zack.webp`

## Scene Facts

- Setting: Thilias market or poor district transition, public space disrupted by magical duplicates and confusion.
- Action: Clone-like enemies or illusions create chaos around Rose and the party.
...
```text
Create one Book 1 moment illustration for Magium: The clone ambush begins.
...
- Setting: Thilias market or poor district transition, public space disrupted by magical duplicates and confusion.
- Action: Clone-like enemies or illusions create chaos around Rose and the party.
- Materials/architecture: Clones should look uncanny through repeated silhouettes, not sci-fi holograms.
- Unnamed/background figures: Duplicate attackers or illusion figures, background civilians retreating.
- Composition: 16:9 confusion scene, repeated forms and party reactions readable.
