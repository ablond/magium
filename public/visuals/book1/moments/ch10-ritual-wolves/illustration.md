# Red eyes in the ritual fog - Book 1 Moment Illustration
...
- Chapter: `ch10`
- Trigger scene: `Ch10-Wolves`
- Moment id: `ch10-ritual-wolves`
...
- Setting: Forest edge after the ritual fog has mostly disappeared, with tree depth and red eyes visible beyond the group.
- Action: Oversized black wolf silhouettes reveal themselves at the edge of the woods while the party notices them and forms a cautious line; show suspense before any attack.
- Materials and architecture: Wolves are at least three times the size of normal wolves, with fur as black as coal and red eyes; they are not werewolves.
- Unnamed figures: Several oversized black wolves in the forest depth, kept as looming silhouettes with readable red eyes; no detailed shaman portrait unless needed.
- Composition: 16:9 suspense scene, red eyes in background, party in cautious line foreground, weapons held without contact.
- Timeline overrides: Barry has crossbow on backpack but should look cautious and outmatched.
...
```text
Create one Book 1 moment illustration for Magium: Red eyes in the ritual fog.
...
- Barry has crossbow on backpack but should look cautious and outmatched.
...
- Setting: Forest edge after the ritual fog has mostly disappeared, with tree depth and red eyes visible beyond the group.
- Action: Oversized black wolf silhouettes reveal themselves at the edge of the woods while the party notices them and forms a cautious line; show suspense before any attack.
- Materials/architecture: Wolves are at least three times the size of normal wolves, with fur as black as coal and red eyes; they are not werewolves.
- Unnamed/background figures: Several oversized black wolves in the forest depth, kept as looming silhouettes with readable red eyes; no detailed shaman portrait unless needed.
- Composition: 16:9 suspense scene, red eyes in background, party in cautious line foreground, weapons held without contact.
...
Avoid:
- No werewolves, no cartoon red eyes; keep all figures separated and keep the wolves at a distance.
