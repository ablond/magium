# Road toward the ogre stronghold - Book 1 Moment Illustration
...
- Chapter: `ch9`
- Trigger scene: `Ch9-Intro`
- Moment id: `ch9-stronghold-road`
...
- Setting: Wild terrain route away from the ruins toward ogre lands, rough path, open sky and dangerous distance.
- Action: The group travels together, tired but moving with purpose toward the stronghold.
- Materials and architecture: Travel packs, worn boots and practical marching spacing should be visible.
- Unnamed figures: none
- Composition: Wide 16:9 journey shot with the party in a staggered line, landscape leading forward.
- Timeline overrides: Barry can have crossbow on backpack.
...
```text
Create one Book 1 moment illustration for Magium: Road toward the ogre stronghold.
...
- Barry can have crossbow on backpack.
...
- Setting: Wild terrain route away from the ruins toward ogre lands, rough path, open sky and dangerous distance.
- Action: The group travels together, tired but moving with purpose toward the stronghold.
- Materials/architecture: Travel packs, worn boots and practical marching spacing should be visible.
- Composition: Wide 16:9 journey shot with the party in a staggered line, landscape leading forward.
...
Avoid:
- No fortress interior yet, no city, no cheerful picnic energy.
