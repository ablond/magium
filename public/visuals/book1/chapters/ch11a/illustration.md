...
- Zack: `public/visuals/book1/characters/zack/portrait.webp`
- Suzie: `public/visuals/book1/characters/suzie/portrait.webp`

## Scene Direction

- The party reaches Thilias, moving from Rose's home life toward an ambush in the Beggar's district.
...
```text
Create one wide chapter illustration for Magium Book 1, Chapter 11A: Thilias.
