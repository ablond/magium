...
The V1 story starts from the original English text, with all currently
available chapters of Book 1, Book 2, and Book 3 playable in French (`ch1`
through `ch11b`, `b2ch1` through `b2ch11c`, then `b3ch1` through `b3ch12b`).
The FR/EN language setting drives the interface, available story text, stat
labels, achievements, and fallback to English when a translated chapter is not
available.
...
- [Book 3 French QA](./docs/translation-qa-book3-fr.md): complete coverage, Book 3 terminology, editorial method, and validation record.
